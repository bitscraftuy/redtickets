...
jQuery(document).ready(function(){
  ...
  jQuery('a.ebp-trigger').click(function(){
  	setTimeout(function(){
    	listar();
    	},3000);
  });
    ...
    jQuery.ajax({
      ...
      success: function (data) {
      		...
      		jQuery.each(talleres, function(index, taller){
      			...
      			parentContainer = jQuery('input[name="TALLERES DESDE LAS '+taller.schedule+' HS."]').parent();

      			var items = parentContainer.contents().find('li');
