...
//audio image thumbnail for lightbox
$audio_image_thumbnail = ! empty( $image ) ? rt_get_image_data( array( "image_url" => $image, "w"=> 75, "h"=> 50, "crop" => true ) ) : "" ;  
$audio_image_thumbnail = is_array( $audio_image_thumbnail ) ? $audio_image_thumbnail["lightbox_thumbnail"] : $image ;
