...
$video_image_thumbnail = ! empty( $video_image ) ? rt_get_image_data( array( "image_url" => $video_image, "w"=> 75, "h"=> 50, "crop" => true ) ) : "" ;  
$video_image_thumbnail = is_array( $video_image_thumbnail ) ? $video_image_thumbnail["lightbox_thumbnail"] : $video_image ;
