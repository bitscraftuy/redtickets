...
class RTTheme{
	...
	public $rt_google_fonts=array(
			...
			"Poppins:400&subset=latin,latin-ext"=> array("Poppins","Poppins"), 
			"Poppins:500&subset=latin,latin-ext"=> array("Poppins","Poppins - Semi Bold"), 
			"Poppins:700&subset=latin,latin-ext"=> array("Poppins","Poppins - Bold"), 
			"Slabo:400&subset=latin,latin-ext"=> array("Slabo","Slabo"),  
			"Montserrat:500&subset=latin,latin-ext"=> array("Montserrat","Montserrat - Semi Bold"), 
			"Montserrat:700&subset=latin,latin-ext"=> array("Montserrat","Montserrat - Bold"), 
			"Montserrat:900&subset=latin,latin-ext"=> array("Montserrat","Montserrat - Extra Bold"), 
	...
	public static function rt_get_product_categories( $parent_ID = 0, $hierarchical_list = false, $depthcount = 1 ){
		...
		if(is_array($product_categories)){
			foreach ($product_categories as $category_list ) {
				...
				//look sub categories  
				$rt_product_getcat = $rt_product_getcat + self::rt_get_product_categories( $category_list->cat_ID, true , $depthcount+1 );
