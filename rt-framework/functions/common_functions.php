...
function rt_check_layer_slider() { 
	if( function_exists( "layerslider_load_lang" ) || function_exists( "layerslider_activation_scripts" ) || function_exists( "layerslider_new_site" ) || defined('LS_PLUGIN_VERSION') ) {
		return true;
	}else{
		return false;
	}
...
function rt_layer_slider_list() { 
	...
	if( function_exists( "lsSliders" ) || defined('LS_PLUGIN_VERSION') ){
