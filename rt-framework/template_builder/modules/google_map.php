			...
			$options = array (
						...
						array(
								"desc" => sprintf(
										...
										empty( $api_key ) ? '<p style="color:red">'.__("Missing Google API Key: Google Maps module requires API key to work properly. Go to RT-Theme 18 > General Options and enter yoour API key. Map module will still work for websites created on before June 22nd, 2016","rt_theme_admin").'<p>' : "" 
										) ,	 
								"hr" => "true",
								"type" => "info", 
						),  
