			...
			echo "<h3>ERROR:</h3><br />".__($wp_upload_dir['error'],'rt_theme_admin');
	 		...
	 		echo '
	 			<div class="import_tempalte">
					...
					<p>
						<label for="upload"><b>Choose the import file from your computer:</b></label><br /> '.sprintf( __('Maximum size: %s', "rt_theme_admin" ), $file_size ).'
						<input type="file" size="25" name="import" id="upload">
					</p>

					<p>
						<label for="oldurl"><b>Old URL:</b></label> <input type="text" size="25" name="oldurl" id="oldurl" placeholder="Old URL" style="display:inline-block;width:300px;"><br />
						'.sprintf( __('If your import file has been generated from another URL, you can replace the old URL with %s by using this field.', "rt_theme_admin" ), '<code>'.get_site_url().'</code>' ).' '. __("Leave it blank if you don't want to change.","rt_theme_admin") .'
					</p>
